...
object pepita {
	...
	method siluetaPepita() {
		// TODO Precalcular la imagen es complejo y propenso a errores, 
		// recomiendo evitar esta estrategia a menos que haya un muy buen motivo para hacerlo.
		// Salvo casos muy puntuales, es más fácil que este cálculo lo hagas cuando te pregunten la imagen.
		if (energia < 10) {
			imagen = "pepita.png"
		} else if (energia > 100) {
			imagen = "pepita2.png"
